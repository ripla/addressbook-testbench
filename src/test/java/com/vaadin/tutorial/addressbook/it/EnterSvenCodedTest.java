...
public class EnterSvenCodedTest extends TestBenchTestCase {
    ...
    public void enterSven() throws InterruptedException {
        ...
        // Assert Sven
        WebElement firstNameCell = driver
                .findElement(By
                        .xpath("id('contact-list')//td[@class='v-table-cell-content'][1]"));
        WebElement lastNameCell = driver
                .findElement(By
                        .xpath("id('contact-list')//td[@class='v-table-cell-content'][2]"));
        WebElement companyCell = driver
                .findElement(By
                        .xpath("id('contact-list')//td[@class='v-table-cell-content'][3]"));
